...
public class SentRequests extends AppCompatActivity {
    ...
    private ListView listSentRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.sent_request));
        StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder().detectNetwork().detectAll().build());
        new Sent_Requests().execute();
    }

    private void init() {
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        listSentRequest = (ListView) findViewById(R.id.listSentRequest);
    }
    ...
    private class Sent_Requests extends AsyncTask<Void, Void, InputStream> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(SentRequests.this);
        ...
        protected InputStream doInBackground(Void... params) {
            ...
            try {
                ...
                inputStream = helper.makeHttpRequest("http://www.waysideutilities.com/api/sent_request.php", "GET", newString);
        ...
        protected void onPostExecute(InputStream inputStream) {
            ...
            if (inputStream != null) {
                ...
                Log.e("Sent Requests : ", stringResult);
                try {
                    ...
                    if (success.equals("1")) {
                        ...
                        listSentRequest.setAdapter(new SentRequestsAdapter(SentRequests.this, listRequests));
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                finish();
                Toast.makeText(SentRequests.this, R.string.networkError, Toast.LENGTH_SHORT).show();
            }
        }
    }
